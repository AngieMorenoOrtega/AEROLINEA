...
const SeatSelector = () => {
  ...
  // }
  const handleSeatClick = (seatId, flightType, cantidadPasajeros) => {
    let selectedSeats = getSelectedSeatsByFlightType(flightType);
    let setSelectedSeats = setSelectedSeatsByFlightType(flightType);
    let totalSelectedSeats = calculateTotalSelectedSeatsByFlightType(flightType);
  ...
  const getSelectedSeatsByFlightType = (flightType) => {
    switch (flightType) {
      case 'outbound':
        return selectedSeatsOutbound;
      case 'outbound2':
        return selectedSeatsOutbound2;
      case 'outbound3':
        return selectedSeatsOutbound3;
      case 'outbound4':
        return selectedSeatsOutbound4;
      case 'return':
        return selectedSeatsReturn;
      case 'return2':
        return selectedSeatsReturn2;
      case 'return3':
        return selectedSeatsReturn3;
      case 'return4':
        return selectedSeatsReturn4;
      default:
        return [];
    }
  };
  ...
  const setSelectedSeatsByFlightType = (flightType) => {
    switch (flightType) {
      case 'outbound':
        return setSelectedSeatsOutbound;
      case 'outbound2':
        return setSelectedSeatsOutbound2;
      case 'outbound3':
        return setSelectedSeatsOutbound3;
      case 'outbound4':
        return setSelectedSeatsOutbound4;
      case 'return':
        return setSelectedSeatsReturn;
      case 'return2':
        return setSelectedSeatsReturn2;
      case 'return3':
        return setSelectedSeatsReturn3;
      case 'return4':
        return setSelectedSeatsReturn4;
      default:
        return () => {};
    }
  };
  ...
  const calculateTotalSelectedSeatsByFlightType = (flightType) => {
    switch (flightType) {
      case 'outbound':
        return [...selectedSeatsOutbound, ...selectedSeatsOutbound2, ...selectedSeatsOutbound3, ...selectedSeatsOutbound4];
      case 'return':
        return [...selectedSeatsReturn, ...selectedSeatsReturn2, ...selectedSeatsReturn3, ...selectedSeatsReturn4];
      default:
        return [];
    }
  };
